...
public class CommentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // from EventListAdapter: onClick -> intent from EventList to Comment View
        // note EventID here
        ...
        mRecyclerView.setHasFixedSize(true);        // optimization, see source code
        mLayoutManager = new LinearLayoutManager(this);
        mRecyclerView.setLayoutManager(mLayoutManager);


        // setOnClickListener listen to comment submit
        // get data, refresh commentAdapter
    ...
    private void getData(final String eventId, final CommentAdapter commentAdapter) {
        mDatabaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                // see CommentAdapter member method
                // set "setCommentNumber"
                // should do "setEvent" first, then setCommentNumber
                commentAdapter.setCommentNumber(comments.size());



                if (mRecyclerView.getAdapter() != null) {
                    commentAdapter.notifyDataSetChanged();      // get data, refresh commentAdapter UI
                } else {
